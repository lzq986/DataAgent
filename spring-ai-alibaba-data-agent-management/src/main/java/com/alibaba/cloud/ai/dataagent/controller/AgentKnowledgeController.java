...
public class AgentKnowledgeController {
	 ...
	 */
	// @PostMapping
	// public ResponseEntity<Map<String, Object>> createKnowledge(@RequestBody
	...
	//// && "active".equals(knowledge.get())) {
	//// try {
	//// agentKnowledgeService.addKnowledgeToVectorStore(Long.valueOf(knowledge.getAgentId()),
	// knowledge);
	 ...
	 */
	// @PutMapping("/{id}")
	// public ResponseEntity<Map<String, Object>> updateKnowledge(@PathVariable("id")
	// Integer id,
	...
	//// }
	//// else if ((contentChanged || statusChangedToActive) &&
	// "active".equals(updatedKnowledge.getStatus())
	...
	//// // delete
	//// // old
	//// agentKnowledgeService.addKnowledgeToVectorStore(agentId, updatedKnowledge); //
	// Then
	//// // add
	//// // new
	...
	// */
	// @DeleteMapping("/{id}")
	// public ResponseEntity<Map<String, Object>> deleteKnowledge(@PathVariable("id")
	// Integer id) {
	// Map<String, Object> response = new HashMap<>();
	//
	// try {
	...
	// public ResponseEntity<Map<String, Object>> batchUpdateStatus(@RequestBody
	...
	// getKnowledgeStatistics(@PathVariable("agentId") Integer agentId) {
	// Map<String, Object> response = new HashMap<>();
	//
	// try {
	// int totalCount = agentKnowledgeService.countKnowledgeByAgent(agentId);
	// List<Object[]> typeStatistics =
	// agentKnowledgeService.countKnowledgeByType(agentId);
	//
