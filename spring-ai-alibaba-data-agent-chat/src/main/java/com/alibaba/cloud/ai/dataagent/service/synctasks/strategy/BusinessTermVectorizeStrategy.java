...
@Component
@Slf4j
public class BusinessTermVectorizeStrategy implements VectorizeStrategy {

	@Override
	public boolean vectorize(SyncTasks task) {
		// TODO: 处理BUSINESS_TERM类型
		log.info("BUSINESS_TERM type vectorization not implemented yet: entityId={}", task.getEntityId());
		return true;
	}
